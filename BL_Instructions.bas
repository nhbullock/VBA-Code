...
Sub BL_Instructions()
Attribute BL_Instructions.VB_ProcData.VB_Invoke_Func = " \n14"
'
' BL_Instructions Macro
'
...
Worksheets("BL INSTRUCTIONS").Cells(4, 6).Value = Worksheets("Shipping Details").Cells(row, 24).Value 'Booking No'
Worksheets("BL INSTRUCTIONS").Cells(6, 6).Value = Worksheets("Shipping Details").Cells(row, 1).Value 'Sales Order #'
Worksheets("BL INSTRUCTIONS").Cells(24, 4).Value = Worksheets("Shipping Details").Cells(row, 29).Value 'Loading Location
...
Worksheets("BL INSTRUCTIONS").Cells(26, 4).Value = Worksheets("Shipping Details").Cells(row, 30).Value 'Load port'
Worksheets("BL INSTRUCTIONS").Cells(28, 1).Value = Worksheets("Shipping Details").Cells(row, 33).Value 'Destination'
Worksheets("BL INSTRUCTIONS").Cells(28, 4).Value = Worksheets("Shipping Details").Cells(row, 33).Value 'Destination'

Worksheets("BL INSTRUCTIONS").Cells(14, 6).Value = "USA"

Worksheets("BL INSTRUCTIONS").Cells(31, 5).Value = Worksheets("Shipping Details").Cells(row, 136).Value 'AES ITN #?'
...
For s = 32 To 62
    If IsEmpty(Worksheets("Shipping Details").Cells(row, 2 * (s - 31) + 56).Value) = False Then
        ...
        Worksheets("BL INSTRUCTIONS").Cells(s, 3).Value = Format(Worksheets("Shipping Details").Cells(row, 2 * (s - 31) + 57).Value / 2204.6, "#,##0.000")
    End If
Next
...
Worksheets("BL INSTRUCTIONS").Cells(35, 4).Value = Worksheets("Shipping Details").Cells(row, 7).Value 'Product Description'
Worksheets("BL INSTRUCTIONS").Cells(8, 12).Value = Worksheets("Shipping Details").Cells(row, 1) 'Sales Order #'
...
Sheets("Forms").Select
Sheets("BL INSTRUCTIONS").Select
    Sheets("BL INSTRUCTIONS").Copy
'
Application.ScreenUpdating = True
End Sub
Sub Canada_BL_Instructions()
Attribute Canada_BL_Instructions.VB_ProcData.VB_Invoke_Func = " \n14"
'
' Canada_BL_Instructions Macro
'
Dim I As Integer, row As Integer
...
Worksheets("BL INSTRUCTIONS").Cells(31, 5).Value = Worksheets("Shipping Details").Cells(row, 126).Value

Worksheets("BL INSTRUCTIONS").Cells(14, 6).Value = "CANADA"
...
For s = 32 To 62
    ...
    End If
Next
Worksheets("BL INSTRUCTIONS").Cells(32, 4).Value = Worksheets("Shipping Details").Cells(row, 25).Value & "  x  " & Worksheets("Shipping Details").Cells(row, 44).Value & " Containers  "
Worksheets("BL INSTRUCTIONS").Cells(35, 4).Value = Worksheets("Shipping Details").Cells(row, 7).Value
Worksheets("BL INSTRUCTIONS").Cells(8, 12).Value = Worksheets("Shipping Details").Cells(row, 1)
...
End Sub
Sub Create_US_Docs()
Attribute Create_US_Docs.VB_ProcData.VB_Invoke_Func = " \n14"
'
' Create_US_Docs Macro

Dim I As Integer, row As Integer, consignee As Integer, notify As Integer, buyer As Integer
Application.ScreenUpdating = False

'Search column I in Shipping Details for Sales Order Number'
For I = 3 To 1000
    If Worksheets("Shipping Details").Cells(I, 1).Value = Worksheets("Forms").Cells(4, 7).Value Then
    row = I
    I = 1000
...
Worksheets("BL INSTRUCTIONS").Cells(14, 6).Value = "USA" 'Country of Origin'
Worksheets("BL INSTRUCTIONS").Cells(31, 5).Value = Worksheets("Shipping Details").Cells(row, 136).Value 'CAED vs AES'
...
Worksheets("CI").Cells(19, 10).Value = "UNITED STATES OF AMERICA" 'Country of Origin of Goods'
Worksheets("CI").Cells(19, 12).Value = "USA" 'Country Code'
...
Worksheets("CI").Cells(70, 3).Value = "OF UNITED STATES OF AMERICA ORIGIN"
...
For s = 34 To 53 'Page 1'
    If IsEmpty(Worksheets("Shipping Details").Cells(row, 2 * (s - 33) + 56).Value) = False Then
        ...
        Worksheets("CO").Cells(s, 4).Value = Format(Worksheets("Shipping Details").Cells(row, 2 * (s - 33) + 57).Value / 2204.6, "#,##0.000")
...
For s = 95 To 109 'Page 2'
    If IsEmpty(Worksheets("Shipping Details").Cells(row, 2 * (s - 94) + 56).Value) = False Then
        ...
        Worksheets("CO").Cells(s, 4).Value = Format(Worksheets("Shipping Details").Cells(row, 2 * (s - 94) + 97).Value / 2204.6, "#,##0.000")
        Worksheets("CO").Cells(s, 8).Value = "MT"
    End If
Next

Worksheets("co").Cells(8, 14).Value = Worksheets("Shipping Details").Cells(row, 1).Value 'PO Number'
Worksheets("co").Cells(122, 13).Value = Worksheets("Shipping Details").Cells(row, 44).Value 'Container size - posted on side'
...
Worksheets("PACKING LIST").Cells(12, 4).Value = Worksheets("CI").Cells(37, 6) 'Description of Goods (Shipping Details Column 7'
...
Worksheets("PD").Cells(46, 2).Value = "GREELEY, CO " & Worksheets("Shipping Details").Cells(row, 36).Value 'Greeley and Date from CO'
...
Worksheets("PD").Cells(8, 14).Value = Worksheets("Shipping Details").Cells(row, 1) 'PO number'
